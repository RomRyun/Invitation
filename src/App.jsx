        ...
        <div style={{
          ...
          <motion.div
            style={{
              ...
              height: '100%',
              scale: imageScale,
              // 3개의 먹물 번짐 (메인/좌상단=원형, 우하단=타원형, 느린 속도)
              WebkitMaskImage: useTransform(maskSize, (size) => {
                ...
                return `
                  ...
                  radial-gradient(ellipse 50% 60% at 72% 68%, black ${s3 * 0.5}%, rgba(0,0,0,0.5) ${s3 * 0.75}%, transparent ${s3 + 22}%)
                `;
              }),
